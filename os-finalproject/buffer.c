/* *************************************************************/
/* Nicholas Mercurio, Jay Lansiquot, Gabe Miller, Matthew Wong */
/* SYST 44288                                                  */
/* buffer.c                                                    */
/* 11/18/2018                                                  */
/* *************************************************************/
...
void *producer(void *param) {
	...
	while(TRUE) {
		...
		// Checks if there is an error inserting random number
